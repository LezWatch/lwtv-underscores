...
<div id="main" tabindex="-1" class="site-main" role="main">
				...
				<div class="col-sm-8">
					<div class="site-loop home-featured-post-loop">
						<h2 class="posts-title">
							New Posts <?php echo lwtv_plugin()->get_symbolicon( svg: 'newspaper.svg', fontawesome: 'fa-newspaper' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</h2>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="card-meta text-muted">
										<?php the_date(); ?>
										<?php echo lwtv_plugin()->get_symbolicon( svg: 'user-circle.svg', fontawesome: 'fa-user-circle' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
										<?php the_author(); ?>
									</div>
									<div class="card-text">
										<?php the_excerpt(); ?>
	...
	<section class="home-featured-shows">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2>Shows We Love <?php echo lwtv_plugin()->get_symbolicon( svg: 'hearts.svg', fontawesome: 'fa-heart' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h2>
				</div>
			</div>
			<?php
	...
	<section class="home-older-posts">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="posts-title">
						More Posts <?php echo lwtv_plugin()->get_symbolicon( svg: 'newspaper.svg', fontawesome: 'fa-newspaper' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					</h2>
				</div>
			</div>
			<?php
