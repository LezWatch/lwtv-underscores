...
if ( get_post_meta( get_the_ID(), 'lezshows_worthit_show_we_love', true ) ) {
	...
	$icon .= ' <span role="img" aria-label="We Love This Show!" data-bs-target="tooltip" title="We Love This Show!" class="show-we-love" style="max-width: 50px; max-height: 50px">' . $heart . '</span>';
}
