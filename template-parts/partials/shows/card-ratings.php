	...
	<div class="card">
		...
		<div class="card-body">
			...
			if ( ! $realness && ! $quality && ! $screentime ) {
				...
				$heart          = lwtv_plugin()->get_symbolicon( 'heart.svg', 'fa-heart' );
				$positive_heart = '<span role="img" class="show-heart positive" style="max-width: 30px; max-height: 30px">' . $heart . '</span>';
				$negative_heart = '<span role="img" class="show-heart negative" style="max-width: 30px; max-height: 30px">' . $heart . '</span>';
