...
- Gutenberg API versions compatibility. No code changes.
...
- Race condition with character of the day double running.
- "None!" trope being removed if it was the only trope on a show.
