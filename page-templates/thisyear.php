...
$iconpath = '<span role="img" aria-label="post_type_characters" title="Calendar" class="taxonomy-svg calendar">' . lwtv_plugin()->get_symbolicon( svg: 'calendar-15.svg', fontawesome: 'fa-calendar-alt' ) . '</span>';
