...
class Statistics_Cache_Warming {
	...
	private function warm_shows_counts(): void {
		...
		lwtv_plugin()->debug_log( 'statistics', 'Warming shows count caches. This year: ' . count( $this_year_shows ) . ', All: ' . $all_shows );
	}
	...
	private function warm_death_counts(): void {
		...
		lwtv_plugin()->debug_log( 'statistics', 'Warming death count caches. This year: ' . count( $this_year_deaths ) . ', Characters: ' . $all_deaths . ', Shows: ' . $total_dead_shows );
	}
	...
	private function warm_station_statistics(): void {
		...
		lwtv_plugin()->debug_log( 'statistics', 'Warming station statistics caches...' );
	}
	...
	private function warm_nation_statistics(): void {
		...
		lwtv_plugin()->debug_log( 'statistics', 'Warming nation statistics caches...' );
	}
	...
	private function warm_formats_statistics(): void {
		...
		lwtv_plugin()->debug_log( 'statistics', 'Warming formats statistics caches...' );
	}
	...
	private function warm_loved_statistics(): void {
		...
		lwtv_plugin()->debug_log( 'statistics', 'Warming loved statistics caches...' );
	}
