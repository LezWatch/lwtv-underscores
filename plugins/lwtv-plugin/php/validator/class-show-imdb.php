<?php
/*
 * Validation: Show IMDb Checks For LezWatch.TV
 *
 */
...
class Show_IMDb {
	...
	public static function make() {
		...
		$last_run = ( new Validation() )->last_run( 'show_imdb' );
		...
		if ( empty( $items ) || ! is_array( $items ) ) {
			...
			<div class="lwtv-tools-container lwtv-tools-container__alert">
				...
				<div id="lwtv-tools-alerts">
					<p>The following <?php echo esc_html( $have ); ?> invalid IMDb data or lack any IMDb data at all. Not all will be possible to fix, as many webseries and international shows aren't listed on IMDb.</p>
					<?php echo wp_kses_post( $last_run ); ?>
				</div>
			</div>
