...
class Post_Editor {
	...
	public function __construct() {
		add_action( 'admin_head', array( $this, 'single_scroll_on_small_screens' ) );
	}

	/**
	 * Restore single-scroll post editor on small screens.
	 *
	 ...
	 */
	public function single_scroll_on_small_screens(): void {
