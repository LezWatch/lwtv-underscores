...
class CMB2 {
	...
	public function __construct() {
		 ...
		 */
		// CMB2 Grid
		require_once LWTV_THEME_PATH . '/plugins/cmb2-grid/Cmb2GridPluginLoad.php';
		// Select2
		require_once LWTV_THEME_PATH . '/plugins/cmb-field-select2/cmb-field-select2.php';
		// Attached Posts
		require_once LWTV_THEME_PATH . '/plugins/cmb2-attached-posts/cmb2-attached-posts-field.php';
	}
