...
class Gravity_Forms {
	...
	public function dequeue_scripts() {
		if ( is_front_page() || is_home() || is_singular( 'post' ) || is_page_template( '/lwtv-underscores/page-templates/statistics.php' ) || is_page_template( '/lwtv-underscores/page-templates/thisyear.php' ) || is_archive() ) {
