...
class CMB2_Metaboxes {
	...
	public function cmb2_metaboxes() {
		...
		$this->cmb2_metabox_group_general( $post_id );
		$this->cmb2_metabox_group_appearances();
	}

	/*
	 * CMB2 Metabox Group: Appearances
	 */
	public function cmb2_metabox_group_appearances() {
		...
		$group_shows = $cmb_appearances->add_field(
			array(
				'id'         => self::PREFIX . 'show_group',
				'type'       => 'group',
				'repeatable' => true,
				'options'    => array(
					'group_title'   => 'Show #{#}',
		...
		// Field: Show Name
		$cmb_appearances->add_group_field(
			$group_shows,
			array(
				'name'       => 'TV Show',
				'id'         => 'show',
	...
	/*
	 * CMB2 Metabox Group: General
	 */
	public function cmb2_metabox_group_general( $post_id ) {
		...
		$cmb_characters->add_field(
			array(
				...
				'id'                => self::PREFIX . 'relationship_chart',
		...
		$group_alt_images = $cmb_characters->add_field(
			array(
				'id'         => self::PREFIX . 'character_image_group',
				'type'       => 'group',
				'repeatable' => true,
				'options'    => array(
