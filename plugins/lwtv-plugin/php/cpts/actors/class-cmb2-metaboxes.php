...
class CMB2_Metaboxes {
	...
	public function cmb2_metaboxes() {
		...
		$this->cmb2_metabox_group_queerness();
		$this->cmb2_metabox_group_life_stats();
		$this->cmb2_metabox_group_socials();
		$this->cmb2_metabox_group_misc();
	}
	 ...
	 * @return array
	 */
	public function cmb2_metabox_group_queerness() {
		...
		$field_gender = $cmb_actorside_queer->add_field(
			array(
				'name'             => 'Gender',
		...
		$field_sexuality = $cmb_actorside_queer->add_field(
			array(
				'name'             => 'Sexuality',
		...
		$field_romantic = $cmb_actorside_queer->add_field(
			array(
		...
		$field_queer_override = $cmb_actorside_queer->add_field(
			array(
				'name'    => 'Queer Override',
		...
		$field_pronouns = $cmb_actorside_queer->add_field(
			array(
				'name'              => 'Pronouns',
		...
		if ( ! is_admin() ) {
			...
			$grid_actorside_queer = new \Forked\CMB2\CMB2Grid\Grid\Cmb2Grid( $cmb_actorside_queer );
			$row1                 = $grid_actorside_queer->addRow();
			$row2                 = $grid_actorside_queer->addRow();
			$row3                 = $grid_actorside_queer->addRow();
	...
	/**
	 * Generate the metabox for an actor's life stats (birth, death, etc)
	 */
	public function cmb2_metabox_group_life_stats() {

		// Metabox Group: Quick Dropdowns
		$cmb_actorside_life = \new_cmb2_box(
			array(
				'id'           => 'actors_life_metabox',
				'title'        => 'Life Data',
				'object_types' => array( 'post_type_actors' ),
				'context'      => 'normal',
				'priority'     => 'default',
		...
		// Field: Year of Birth
		$field_birth = $cmb_actorside_life->add_field(
			array(
				'name'        => 'Date of Birth',
				'desc'        => 'If known',
		...
		$field_death = $cmb_actorside_life->add_field(
			array(
				'name'        => 'Date of Death',
				'desc'        => 'If applicable',
		...
		if ( ! is_admin() ) {
			...
			$grid_actorsidelife = new \Forked\CMB2\CMB2Grid\Grid\Cmb2Grid( $cmb_actorside_life );
			$row1               = $grid_actorsidelife->addRow();
			$row1->addColumns( array( $field_birth, $field_death ) );
		}
	}

	/**
	 * Generate the metabox for an actor's social media
	 */
	public function cmb2_metabox_group_socials() {

		// Metabox Group: Quick Dropdowns
		$cmb_actorside_social = \new_cmb2_box(
			array(
				'id'           => 'actors_socials_metabox',
		...
		// Field: IMDb ID
		$field_imdb = $cmb_actorside_social->add_field(
			array(
				'name'       => 'IMDb',
				'id'         => self::PREFIX . 'imdb',
				'type'       => 'text',
		...
		// Field: WikiPedia
		$field_wiki = $cmb_actorside_social->add_field(
			array(
				'name'       => 'WikiPedia URL',
		...
		// Field: Home URL
		$field_home = $cmb_actorside_social->add_field(
			array(
				'name'       => 'Homepage URL',
		...
		// Field: Twitter ID
		$field_twitter = $cmb_actorside_social->add_field(
			array(
				'name'       => 'X (Twitter)',
		...
		// Field: Tumblr ID
		$field_tumblr = $cmb_actorside_social->add_field(
			array(
				'name'       => 'Tumblr',
		...
		// Field: Mastodon URL
		$field_mastodon = $cmb_actorside_social->add_field(
			array(
				'name'       => 'Mastodon',
		...
		// Field: Facebook URL
		$field_facebook = $cmb_actorside_social->add_field(
			array(
				'name'       => 'Facebook',
		...
		// Field: TikTok URL
		$field_tiktok = $cmb_actorside_social->add_field(
			array(
				'name'       => 'TikTok',
		...
		if ( ! is_admin() ) {
			...
			$grid_actorside_social = new \Forked\CMB2\CMB2Grid\Grid\Cmb2Grid( $cmb_actorside_social );
			$row1                  = $grid_actorside_social->addRow();
			$row2                  = $grid_actorside_social->addRow();
			$row3                  = $grid_actorside_social->addRow();
	...
	/**
	 * Generate the metabox for an actor's misc data
	 */
	public function cmb2_metabox_group_misc() {

		// Metabox Group: Quick Dropdowns
		$cmb_actorside_misc_admin = \new_cmb2_box(
			array(
				'id'           => 'actors_misc_admin_metabox',
				'title'        => 'Misc./Admin Tools',
				'object_types' => array( 'post_type_actors' ),
				'context'      => 'normal',
				'priority'     => 'default',
				'show_names'   => true, // Show field names on the left
		...
		// Field: WikiData QID
		$field_wikidata = $cmb_actorside_misc_admin->add_field(
			array(
				'name'       => 'WikiData ID',
		...
		// Field: Excerpt
		$field_excerpt = $cmb_actorside_misc_admin->add_field(
			array(
		...
		$field_make_private = $cmb_actorside_misc_admin->add_field(
			array(
		...
		// Privacy Notes
		$field_make_private_note = $cmb_actorside_misc_admin->add_field(
			array(
		...
		if ( ! is_admin() ) {
			...
			$grid_actorside_misc_admin = new \Forked\CMB2\CMB2Grid\Grid\Cmb2Grid( $cmb_actorside_misc_admin );
			$row1                      = $grid_actorside_misc_admin->addRow();
			$row2                      = $grid_actorside_misc_admin->addRow();
			$row3                      = $grid_actorside_misc_admin->addRow();
			$row1->addColumns( array( $field_wikidata ) );
			$row2->addColumns( array( $field_excerpt ) );
			$row3->addColumns( array( $field_make_private, $field_make_private_note ) );
		}
	}
