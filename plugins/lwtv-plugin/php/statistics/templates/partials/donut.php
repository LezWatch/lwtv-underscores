...
// 'mini': identical ring+legend markup to 'compact' below, just without its
// own bordered <section> card — for callers that want several small donuts
// sharing one outer card (e.g. actors/unknown.php's "Who Are These
// Characters?" trio) instead of each one getting its own nested box.
if ( 'mini' === $donut_layout ) :
	$donut_has_pct = isset( $donut['center_pct'] );
	$donut_family  = $donut['center_family'] ?? '';
	?>
	<div class="lwtv-donut-mini">
