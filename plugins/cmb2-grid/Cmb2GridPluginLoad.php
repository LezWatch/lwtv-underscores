...
namespace Forked\CMB2\CMB2Grid;

if ( ! defined( 'CMB2GRID_DIR' ) ) {
	define( 'CMB2GRID_DIR', trailingslashit( __DIR__ ) );
}

if ( ! class_exists( 'Forked\CMB2\CMB2Grid\Cmb2GridPlugin' ) ) {
...
if ( ! function_exists( 'Forked\CMB2\CMB2Grid\init' ) ) {
	/**
...
add_action( 'cmb2_init', 'Forked\CMB2\CMB2Grid\init' );
