...
function wp_bootstrap_pagination( $args = array() ) {
	...
	if ( $firstpage && ( 1 !== $page ) ) {
		$echo .= '<li class="page-item first me-auto"><a href="' . $firstpage . '" class="page-link">' . lwtv_plugin()->get_symbolicon( svg: 'caret-left-circle.svg', icon: 'svg-chevron-circle-left' ) . ' ' . __( 'First', 'text-domain' ) . '</a></li>';
	}

	if ( $previous && ( 1 !== $page ) ) {
		$echo .= '<li class="page-item previous"><a href="' . $previous . '" title="' . __( 'previous', 'text-domain' ) . '" class="page-link">' . lwtv_plugin()->get_symbolicon( svg: 'caret-left-circle.svg', icon: 'svg-chevron-circle-left' ) . ' ' . $args['previous_string'] . '</a></li>';
	}
